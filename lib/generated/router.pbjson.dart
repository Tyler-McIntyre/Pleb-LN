...
const SendPaymentRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'time_pref', '3': 23, '4': 1, '5': 1, '10': 'timePref'},
  ],
...
final $typed_data.Uint8List sendPaymentRequestDescriptor = $convert.base64Decode('');
...
const ForwardHtlcInterceptResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'failure_message', '3': 4, '4': 1, '5': 12, '10': 'failureMessage'},
    const {'1': 'failure_code', '3': 5, '4': 1, '5': 14, '6': '.lnrpc.Failure.FailureCode', '10': 'failureCode'},
  ],
};

/// Descriptor for `ForwardHtlcInterceptResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List forwardHtlcInterceptResponseDescriptor = $convert.base64Decode('');
